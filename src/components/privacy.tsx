          ...
          <CardContent className="p-8 prose prose-gray dark:prose-invert max-w-none">
            <div className="space-y-8">
              <section>
                ...
                <p className="text-muted-foreground">
                  At Hosteling, we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, 
                  use, disclose, and safeguard your information when you use our platform. Please read this policy carefully to understand our practices.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                  ...
                  <li>Profile information (bio, skills, preferences, photos)</li>
                  <li>Contact details and location information</li>
                  <li>Communication content (messages, reviews, forum posts)</li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2">
                  ...
                  <li>Match volunteers with appropriate hostel opportunities</li>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Profile information is visible to other users to facilitate matching and communication. 
                  You control what information is displayed in your profile.
                </p>

                <h3 className="text-lg font-semibold mb-3">With Service Providers</h3>
                <p className="text-muted-foreground mb-4">
                ...
                <h3 className="text-lg font-semibonal mb-3">Legal Requirements</h3>
                <p className="text-muted-foreground mb-4">
              ...
              <section>
                ...
                <div className="bg-muted p-4 rounded-lg mt-4">
                  <p className="text-sm">
                    <strong>Hosteling Privacy Team</strong><br />
                    Email: privacy@hostelingapp.com<br />
                    Subject Line: Privacy Policy Inquiry<br /><br />
                    For data protection rights requests:<br />
                    Email: dpo@hostelingapp.com<br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                ...
                <div className="cursor-pointer hover:text-foreground">Data Rights</div>
              </div>
            </div>
            <div className="space-y-4">
              <h4>Support</h4>
