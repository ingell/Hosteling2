          ...
          <Card className="bg-gradient-to-r from-orange-50 to-yellow-50 dark:from-orange-950/20 dark:to-yellow-950/20 border-0">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                If you're currently volunteering and facing an emergency or
                urgent safety concern, please contact your local emergency
                services first, then reach out to us immediately.
              </p>
