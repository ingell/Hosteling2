          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                ...
                <div className="cursor-pointer hover:text-foreground">Support Center</div>
                <div className="cursor-pointer hover:text-foreground">Live Chat</div>
                <div className="cursor-pointer hover:text-foreground">Emergency Support</div>
              </div>
            </div>
            <div className="space-y-4">
              <h4>Support</h4>
