...
const volunteerDashboardData = {
  ...
  recentActivity: [
    { id: 1, text: "Started volunteering at Beach Paradise Hostel", date: "Nov 15", type: "started" },
    { id: 2, text: "Received 5-star review from Surf & Stay", date: "Nov 10", type: "review" },
    { id: 3, text: "Applied to Mountain Hostel in Peru", date: "Nov 5", type: "applied" }
  ],
...
const hostelDashboardData = {
  user: {
    ...
    avatar: "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=40&h=40&fit=crop",
  ...
  recentActivity: [
    { id: 1, text: "New application from Emma Johnson", date: "2 days ago", type: "application" },
    { id: 2, text: "Tom Wilson extended stay until Jan 15", date: "3 days ago", type: "extension" },
    { id: 3, text: "Received 5-star review from Sarah Chen", date: "1 week ago", type: "review" }
  ]
};
...
export function LoggedInView({ userType, onLogout }: LoggedInViewProps) {
  ...
  const userData = isVolunteer ? volunteerDashboardData.user : hostelDashboardData.user;
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button 
                variant="ghost" 
                size="sm"
                onClick={() => setCurrentView(isVolunteer ? "volunteer-profile" : "hostel-profile")}
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl mb-2">
            Welcome back, {isVolunteer ? userData.name : hostelDashboardData.user.contactName}!
          </h1>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-2xl">{volunteerDashboardData.user.completedVolunteering}</p>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-2xl">{volunteerDashboardData.user.rating}</p>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-2xl">{volunteerDashboardData.currentVolunteering.daysLeft}</p>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-2xl">{volunteerDashboardData.savedOpportunities.length}</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <CardContent>
                      <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                        <div className="flex items-center justify-between">
                          <div>
                            <h3 className="font-medium">{volunteerDashboardData.currentVolunteering.hostelName}</h3>
                            <p className="text-sm text-muted-foreground flex items-center">
                              <MapPin className="w-3 h-3 mr-1" />
                              {volunteerDashboardData.currentVolunteering.location}
                            </p>
                            <p className="text-sm mt-1">Role: {volunteerDashboardData.currentVolunteering.role}</p>
                            <p className="text-xs text-muted-foreground">
                              {volunteerDashboardData.currentVolunteering.startDate} - {volunteerDashboardData.currentVolunteering.endDate}
                            </p>
                          </div>
                          <div className="text-right">
                            <div className="text-2xl font-bold text-green-600">{volunteerDashboardData.currentVolunteering.daysLeft}</div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {volunteerDashboardData.upcomingOpportunities.map((opportunity) => (
                          <div key={opportunity.id} className="flex items-center space-x-4 p-4 border rounded-lg">
                            <ImageWithFallback
                ...
                <div className="space-y-6">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        {volunteerDashboardData.recentActivity.map((activity) => (
                          <div key={activity.id} className="flex items-start space-x-3">
                            <div className={`w-2 h-2 rounded-full mt-2 ${
                              activity.type === 'started' ? 'bg-green-500' :
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        {volunteerDashboardData.savedOpportunities.map((opportunity) => (
                          <div key={opportunity.id} className="flex items-center space-x-3">
                            ...
                            />
                            <div className="flex-1">
                              <h5 className="text-sm font-medium">{opportunity.name}</h5>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-2xl">{hostelDashboardData.user.totalVolunteers}</p>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-2">
                      <Star className="w-5 h-5 text-yellow-500" />
                      <div>
                        <p className="text-2xl">{hostelDashboardData.user.rating}</p>
                        <p className="text-sm text-muted-foreground">Rating</p>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-2">
                      <Clock className="w-5 h-5 text-blue-500" />
                      <div>
                        <p className="text-2xl">{hostelDashboardData.currentVolunteers.length}</p>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-2xl">{hostelDashboardData.pendingApplications.length}</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {hostelDashboardData.pendingApplications.map((application) => (
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {hostelDashboardData.currentVolunteers.map((volunteer) => (
                          <div key={volunteer.id} className="flex items-center space-x-4 p-4 border rounded-lg">
                            <Avatar>
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-muted-foreground">Until {volunteer.endDate}</p>
                            </div>
                            <div className="text-right">
                              <div className="flex items-center text-sm mb-2">
                                <Star className="w-3 h-3 mr-1 fill-yellow-400 text-yellow-400" />
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium">{hostelDashboardData.stats.responseRate}</span>
                        </div>
                      </div>
                      <div>
                        <div className="flex justify-between text-sm">
                          <span>Average Stay</span>
                          <span className="font-medium">{hostelDashboardData.stats.averageStay}</span>
                        </div>
                      </div>
                      <div>
                        <div className="flex justify-between text-sm">
                          <span>Repeat Volunteers</span>
                          <span className="font-medium">{hostelDashboardData.stats.repeatVolunteers}</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                        ...
                        {hostelDashboardData.recentActivity.map((activity) => (
                          <div key={activity.id} className="flex items-start space-x-3">
                            <div className={`w-2 h-2 rounded-full mt-2 ${
                              ...
                              activity.type === 'extension' ? 'bg-green-500' : 'bg-yellow-500'
                            }`}></div>
                            <div>
                              <p className="text-sm">{activity.text}</p>
                              <p className="text-xs text-muted-foreground">{activity.date}</p>
                    ...
                    {hostelDashboardData.pendingApplications.map((application) => (
                      <div key={application.id} className="flex items-center space-x-4 p-4 border rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            Available: {application.availability} • Applied {application.applied}
                          </p>
                        </div>
                        <div className="text-right">
                          <div className="flex items-center text-sm mb-2">
