...
const benefits = [
  {
    ...
    description:
      "Unlike other platforms that charge hefty commissions, VolunteerStay is completely free for hostels. No setup fees, no monthly costs.",
    features: [
      "No setup fees",
...
const testimonials = [
  {
    ...
    quote:
      "We've hosted 15 volunteers through VolunteerStay this year. They've helped with reception, events, and social media. The platform is free and the volunteers are fantastic!",
    avatar:
  ...
  },
  {
    ...
    quote:
      "VolunteerStay has been a game-changer for us. We get skilled help with our operations and the volunteers bring such positive energy to our hostel community.",
    avatar:
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            <h2>Why hostels choose VolunteerStay</h2>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-muted-foreground">
              Real experiences from hostels using VolunteerStay.
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                commissions, VolunteerStay is completely free.
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              {
                question:
                  "How is VolunteerStay free for hostels?",
                answer:
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              ...
              VolunteerStay to connect them with amazing
