    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-yellow-50">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Choose how you'd like to get started with the world's leading
              volunteer accommodation platform
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <Card
              className="relative overflow-hidden hover:shadow-xl transition-all duration-300 border-2 hover:border-orange-200 group cursor-pointer h-full"
            ...
            >
              ...
              <CardHeader className="text-center pb-4">
                ...
                <p className="text-muted-foreground">
                  Find amazing hostels worldwide and exchange work for
                  accommodation
                </p>
              </CardHeader>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm">
                      Browse thousands of hostels worldwide
                    </span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-orange-500 flex-shrink-0" />
                    <span className="text-sm">
                      Work 4-6 hours for free accommodation
                    </span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-orange-500 flex-shrink-0" />
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-orange-500 flex-shrink-0" />
                    <span className="text-sm">
                      Access to skilled volunteers globally
                    </span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-orange-500 flex-shrink-0" />
