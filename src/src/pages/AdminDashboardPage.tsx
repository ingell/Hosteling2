...
const MOCK_USERS = [
  {
    ...
    applications: 3,
    avatar:
      "https://images.unsplash.com/photo-1494790108755-2616b612b4d4?w=50&h=50&fit=crop&crop=face",
  },
  {
    id: "2",
    type: "volunteer",
  ...
  },
  {
    ...
    applications: 12,
    avatar:
      "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=50&h=50&fit=crop",
  },
  {
    id: "4",
    type: "hostel",
    ...
    applications: 5,
    avatar:
      "https://images.unsplash.com/photo-1555854877-bab0e564b8d5?w=50&h=50&fit=crop",
  },
];
            ...
            <Card>
              ...
              <CardContent>
                <Table>
                  ...
                  <TableBody>
                    {MOCK_USERS.filter((user) => user.type === "volunteer").map(
                      (user) => (
            ...
            <Card>
              ...
              <CardContent>
                <Table>
                  ...
                  <TableBody>
                    {MOCK_USERS.filter((user) => user.type === "hostel").map(
                      (hostel) => (
